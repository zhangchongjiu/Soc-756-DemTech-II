...
ggsave("lx1.png", p1, width = 6, height = 5, dpi = 300, bg = "white")
ggsave("ndx1.png", p2, width = 6, height = 5, dpi = 300, bg = "white")
ggsave("nmx1.png", p3, width = 6, height = 5, dpi = 300, bg = "white")
